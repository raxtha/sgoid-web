                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <input class="form-control" type="hidden" name="passwordlama" value="<?php echo $data->password; ?>" required>
                                        <input class="form-control" type="hidden" name="kode" required value="<?php echo $this->encrypt->encode($data->nip, $this->session->userdata('id_user'));?>">

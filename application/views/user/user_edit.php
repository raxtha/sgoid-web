                        ...
                        <div class="form">
                            ...
                            ?>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="radio" name="data[level]" <?php if ($data->level=="admin") echo "checked";?> value="admin"> Admin </input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name="data[level]" <?php if ($data->level=="user") echo "checked";?> value="user"> User </input>
                                    </div>
                                </div> 
                                <div class="form-group">

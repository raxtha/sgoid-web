                    ...
                    <div class="panel-body">
						<?php
                                $pesanlink = $this->session->flashdata('pesanlink');
                                    if($pesanlink == ""){}else if($pesanlink == "gagal"){ ?>
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <input class="form-control" type="hidden" name="username" maxlength="50" value="<?php echo $data->username;?>">
                                        <input class="form-control" type="hidden" name="kode" value="<?php echo $this->encrypt->encode($data->id_user, $this->session->userdata('id_user'));?>">
